...
#if defined(NDEBUG)
# error "Mikron cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xd8c11a370fa397e742bd27dc6688cc640b95dcecaefa585515c21ad9c2361aee");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Mikron: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Mikron Signed Message:\n";
...
{
    // Mikron: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Mikron: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Mikron: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1528282549, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04f4e6b8c4cf93099a8f0c6498f7b930171fc8912a5e1655c74ac41630459cf40a84ed5f327db5c6821e236903cb2b78de346592c9e3d02d1a75b34313e86f138d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1528282549;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1325210;
        ...
        assert(block.hashMerkleRoot == uint256("0xd9011fd98801b5063c36a00ca653d368d206c8100ed6f87ff53d55e12b387f9b"));
...
unsigned char pchMessageStart[4] = { 0x4c, 0x87, 0xec, 0xe1 }; // Mikron: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MikronMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MikronMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static MikronMiner(CWallet *pwallet)
{
    printf("MikronMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("mikron-miner");
    ...
    try { loop {
        ...
        printf("Running MikronMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&MikronMiner, pwallet));
}
